...
window.onscroll = function() {
    ...
    if (window.pageYOffset > headerSection.offsetHeight - 75) {
        ...
        logoImage.src = "marriott-logo-black-and-white.png";
    } else {
        nav.classList.remove("active");
        logoImage.src = "purepng.com-marriott-logologobrand-logoiconslogos-251519940649oyste.png";
    }
